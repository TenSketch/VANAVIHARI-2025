  ...
  submitBooking() {
    ...
    if (this.form.valid) {
      ...
      const reservationData = {
        ...
        status: 'reserved',
        bookingId: '', // Will be auto-generated by backend
      ...
      // Create reservation in new backend (requires user login)
      const headers = {
        token: this.authService.getAccessToken() ?? ''
      };
          ...
          next: (response) => {
            if (response.success && response.reservation) {
              ...
              this.showSnackBarAlert(
                'Reservation created! Booking Id: ' + bookingId
              );

              // FOR TESTING: Skip payment gateway
              // Comment out this section when you want to enable payment
              this.showLoader = false;
              ...
              // UNCOMMENT BELOW FOR PRODUCTION WITH PAYMENT GATEWAY
              /*
              ...
              const rU = this.api_url + '/api/payment/callback';
              ...
              this.logMessage(bookingId, this.form.value.gname, "request", msg);
              ...
              let pg_params = new HttpParams()
                ...
                .set('txtAdditionalInfo1', this.subBillerId)
